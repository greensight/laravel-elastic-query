...
class Specification
{
    ...
    //region Filters
    public function allowFilters(AllowedFilter|string ...$filters): static
    {
    ...
    //region Sorts
    public function allowSorts(AllowedSort|string ...$sorts): static
    {
    ...
    //region Aggregates
    public function allowAggregates(AllowedAggregate|string ...$aggregates): static
    {
